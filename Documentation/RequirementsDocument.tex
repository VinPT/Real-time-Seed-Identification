...
\ganttbar{Algorithm testing}{1}{2} \\
\ganttbar{Algorithm Implementation}{3}{7} \ganttnewline
\ganttbar{Algorithm Documentation}{3}{7} \ganttnewline
\ganttmilestone{finish Basic Algorithm}{7} \ganttnewline
